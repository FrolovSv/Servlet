...
/*
 в задании не было сказано какие должны быть числа (целые и с плавающей запятой)
 в задании также не сказано, какой должен быть ответ (целые и с плавающей запятой)
 в задании не перечислены какие арифметические операции должны поддерживаться
Вторая часть ДЗ:
